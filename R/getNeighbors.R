...
#' the number of neighbors on vertical direction, \code{neiStruc}[2]
...
#' graphs, the first row of \code{neiStruc} specifies the number of neighbors on
...
#'
#' @return   A matrix with each row giving the neighbors of a vertex.
...
#'
#' @details   There could be more than one way to define the same 3D neighborhood
